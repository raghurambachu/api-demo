...
This application lists all API endpoint for creating a community forum.

API specs have been provided below for all the routes required for the application.
...
Further I am planning to add implementation for 
- follow/unfollow other user
- upvote questions/answers
- admin dashboard
- to track/block users
- to track questions
